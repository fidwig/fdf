...
SRCS := fdf.c map_load.c map_load2.c inputs.c inputs2.c split_list.c graphics.c graphics2.c free_and_exit.c str.c projections.c matrices.c get_next_line.c get_next_line_utils.c ft_split.c ft_atoi.c atoui.c
SRCS := $(SRCS:%=$(SRC_DIR)/%)
